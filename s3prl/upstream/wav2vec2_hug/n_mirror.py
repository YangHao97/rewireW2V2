...
class MirrorWav2vec():
    ...
    def model_finetuning(self):
        ...
        plt.savefig("n+mirror-7ep.png")
        self.upstream.model.save_pretrained("/home/haoy/da33_scratch/haoy/s3prl/s3prl/upstream/wav2vec2_hug/n+mirror-7ep")


if __name__ == '__main__':
    torch.manual_seed(14172)
    random.seed(14172)
    np.random.seed(14172)
    model = MirrorWav2vec()